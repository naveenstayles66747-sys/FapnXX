...
export const AD_CONFIG = {
  ...
  INTERSTITIAL_COOLDOWN_MS: 45000,            // 45-second cooldown between fullpage interstitials (Non-intrusive)
  INTERSTITIAL_MIN_TRANSITIONS: 6,            // Triggers strictly after 6 or more video card clicks
