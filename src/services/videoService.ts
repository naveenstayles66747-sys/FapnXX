      ...
      if (response.ok) {
        ...
        if (Array.isArray(json) && json.length > 0) {
          return json.map((item: any) => ({
            ...
            views: item.views || `${item.viewsCount || 1} views`,
            likesCount: item.likesCount || 0,
            rating: item.rating || '94%',
      ...
      if (!snap.empty) {
        ...
        snap.forEach((d) => {
          ...
          firestoreVideos.push({
            ...
            adLinkUrl: data.adLinkUrl || data.sourceWebsiteUrl || undefined,
            isExclusive: data.isExclusive !== undefined ? data.isExclusive : undefined,
            isNew: data.isNew !== undefined ? data.isNew : undefined,
            isOriginal: data.isOriginal !== undefined ? data.isOriginal : undefined,
            isSponsored: data.isSponsored !== undefined ? data.isSponsored : undefined,
